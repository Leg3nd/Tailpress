    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <a href="#" class="hover:opacity-95">
                <img src="<?php echo get_template_directory_uri(); ?>/resources/img/aayush-gupta-ljhCEaHYWJ8-unsplash.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="relative container bg-citybreakteal-500 -skew-x-6 w-[46rem] p-2 top-600 top-1/2 opacity-100">
                    <h2 class="font-inter text-2xl text-left text-white skew-x-6 drop-shadow-md md:text-4xl">10 restaurants to visit on a budget in Lisbon in 2023</h2>
                </div>     
            </a>
        </div>              
        <!-- Item 2 -->

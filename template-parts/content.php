<article id="post-<?php the_ID(); ?>" <?php post_class( '' ); ?>>
	<?php if ( is_search() || is_archive() ) : ?>
		...
		<a href="<?php the_permalink();?>" class="block h-full max-w-sm bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 hover:shadow hover:opacity-95" >
